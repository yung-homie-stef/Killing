...
namespace PixelCrushers.DialogueSystem
{
    ...
    /// </summary>
    public class CustomUIQuestLogWindow : QuestLogWindow, IEventSystemUser
    {
        ...
        public RectTransform entriesDetailsContentContainer;
        ...
        private StandardUIInstancedContentManager m_entriesPanelContentManager = new StandardUIInstancedContentManager();
        protected StandardUIInstancedContentManager entriesPanelContentManager
        {
            get { return m_entriesPanelContentManager; }
            set { m_entriesPanelContentManager = value; }
        }
        ...
        protected virtual void RepaintSelectedQuest(QuestInfo quest)
        {
            ...
            if (quest != null)
            {
                ...
                entriesDetailsContentContainer.SetAsLastSibling();
                ...
                for (int i = 0; i < quest.Entries.Length; i++)
                {
                    ...
                    if (entryTemplate != null)
                    {
                        ...
                        detailsPanelContentManager.Add(entryInstance, entriesDetailsContentContainer);
                    }
                }
